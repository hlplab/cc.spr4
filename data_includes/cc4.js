var shuffleSequence = seq("intro", "info", "startprac", "list_ordering", "practice", "endprac", sepWith("sep", anyOf("filler", "StimThat.OriginalThat","StimZero.OriginalThat","StimThat.OriginalZero","StimZero.OriginalZero")), "contact", "sr", "code");
...
var items = [
    ...
    [["StimThat.OriginalZero",[23,0]], ds, {s: ['S1:_Do you do exercise?', 'S2:_I do, yes.', 'I, uh, uh, I guess@MATRIXVERB that@COMPL it@CCSUBJ1 actually changes.@CCVERB1'], id: "7" }],
    ...
    [["StimZero.OriginalThat",[71,0]], ds, {s: ["S1:_Okay, what do you feel are some of the main problems?", "S2:_Well, I'm in a, I'm in an urban area.", "I'm in Dallas.", " And we're finding@MATRIXVERB crime@CCSUBJ1 is@CCVERB1 going@CCVERB2 up@CCVERB3 very quickly and has become a major problem."], id: "28" },
        qs, {q: "Is crime decreasing?", hasCorrect: "No", randomOrder: false},
        sep, {errorMessage: "Wrong. Please wait for the next question", normalMessage: "Please wait for the next question"},
        qs, {q: "Is Dallas an urban area?", hasCorrect: "Yes", randomOrder: false}],
    [["StimThat.OriginalThat",[71,0]], ds, {s: ["S1:_Okay, what do you feel are some of the main problems?", "S2:_Well, I'm in a, I'm in an urban area.", "I'm in Dallas.", " And we're finding@MATRIXVERB that@COMPL crime@CCSUBJ1 is@CCVERB1 going@CCVERB2 up@CCVERB3 very quickly and has become a major problem."], id: "28" },
        qs, {q: "Is crime decreasing?", hasCorrect: "No", randomOrder: false},
        sep, {errorMessage: "Wrong. Please wait for the next question", normalMessage: "Please wait for the next question"},
        qs, {q: "Is Dallas an urban area?", hasCorrect: "Yes", randomOrder: false}],
    [["filler",72], ds, {s: ["S1:_Right I wouldn't be, surprised.", "S2:_I'm just going to have to put it, in the car sometimes and listen to it."], id: "F.16.noSBAR" }],
    ...
    [["filler",80], ds, {s: ['S1:_The b-, yes, and the broken families.', 'We, um, as I said, living in an area of Washington,_D.C.', 'We definitely see this.'], id: "F.48.SBAR" }],
    ...
    [["filler",93], ds, {s: ["S1:_Well, we didn't have any, uh, avid, uh, activities like that.", "S2:_They, they were interested in a lot of things."], id: "F.21.noSBAR" },
